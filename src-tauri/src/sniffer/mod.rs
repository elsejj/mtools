...
use crate::models::{EnrichedPayload, PayloadType, PreprocessedResult, TextMetadata, ToolScoreItem};
use serde_json::json;
                    ...
                    if output.confidence > best_confidence {
                        ...
                        if let Some(prep) = output.preprocessed_text {
                            selected_preprocessed = Some(PreprocessedResult {
                                ...
                                diff_source: None,
                                suggested_output_type: output.suggested_output_type.unwrap_or_else(|| "text".to_string()),
                            });
                        }
