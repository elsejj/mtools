...
export const tauriApi = {
  ...
  simulatePaste: (content?: string, html?: string) =>
    invoke<void>("simulate_paste", { content, html }),
  writeClipboardHtml: (html: string, altText?: string) =>
    invoke<void>("write_clipboard_html", { html, altText }),
  ...
  // 6. 媒体缓存管控
  saveImageCache: (imageBytes: number[]) => invoke<string>("save_image_cache", { imageBytes }),
